...
export const pendencias = [
      ...
      },
      {
        ...
        items: [
          ...
          },
          {
            numero: 3,
            titulo: 'Envio',
            descricao: 'Deverá enviar a ficha eletrotécnica digitalizada para darmos seguimento ao pedido de ligação à rede.'
          }
        ]
      },
      {
  ...
  },
  {
    ...
    content: [
      {
        type: 'text',
        text: 'A Ficha Eletrotécnica submetida, em formato Excel, não está devidamente preenchida. Deverá enviar a ficha eletrotécnica em formato Excel devidamente preenchida para darmos seguimento ao pedido.'
      },
      {
        type: 'steps',
        title: 'Como proceder:',
        items: [
          ...
          {
            numero: 4,
            titulo: 'Envio do Ficheiro Excel',
            descricao: 'Deverá enviar a ficha eletrotécnica em formato Excel devidamente preenchida para darmos seguimento ao pedido de ligação à rede.'
          }
        ]
      },
      {
  ...
  },
  {
    ...
    content: [
      {
        type: 'text',
        text: 'A Ficha Eletrotécnica submetida não está no modelo definido pela Direção Geral de Energia e Geologia (DGEG), ou não está devidamente preenchida. Deverá enviar a ficha eletrotécnica no modelo oficial da DGEG devidamente preenchida para darmos seguimento ao pedido.'
      },
      {
        type: 'steps',
        title: 'Como proceder:',
        items: [
          ...
          },
          {
            numero: 4,
            titulo: 'Envio',
            descricao: 'Deverá enviar a ficha eletrotécnica no modelo oficial da DGEG, devidamente preenchida e assinada, para darmos seguimento ao pedido de ligação à rede.'
          }
        ]
      },
      {
        ...
        download: {
          url: 'assets/files/i016706.xlsx',
          text: 'Download da Ficha Eletrotécnica (Modelo DGEG)'
        }
      }
    ]
  },
  {
    ...
    content: [
      {
        type: 'text',
        text: 'A Ficha Eletrotécnica submetida não está devidamente legível. É necessário que o documento seja claramente legível para validação. Deverá enviar a ficha eletrotécnica com qualidade suficiente para leitura e darmos seguimento ao pedido.'
      },
      {
        type: 'steps',
        title: 'Como proceder:',
        items: [
          ...
          {
            numero: 4,
            titulo: 'Envio do Documento Legível',
            descricao: 'Deverá enviar a ficha eletrotécnica com qualidade de imagem/digitalização adequada, garantindo que todos os campos, texto e assinatura estão claramente legíveis para darmos seguimento ao pedido.'
          }
        ]
      },
      {
  ...
  },
  {
    ...
    content: [
      {
        type: 'text',
        text: 'Para dar seguimento ao pedido é necessário submeter o termo de responsabilidade de execução. O termo de responsabilidade de execução poderá ser obtido em dgeg.gov.pt e deve ser preenchido por um técnico habilitado para o efeito. Deverá enviar o termo de responsabilidade, para darmos seguimento ao pedido de ligação à rede.'
      },
      {
        type: 'steps',
        title: 'Como proceder:',
        items: [
          ...
          },
          {
            numero: 3,
            titulo: 'Envio',
            descricao: 'Deverá enviar o termo de responsabilidade digitalizado para darmos seguimento ao pedido de ligação à rede.'
          }
        ]
      },
      {
    ...
    content: [
      ...
      },
      {
        ...
        items: [
          ...
          {
            numero: 3,
            titulo: 'Verificar e Reenviar',
            descricao: 'Verifique se todos os campos obrigatórios estão devidamente preenchidos e envie a ficha eletrotécnica corrigida para darmos seguimento ao pedido.'
          }
        ]
      },
      {
      ...
      },
      {
        ...
        items: [
          ...
          },
          {
            numero: 3,
            titulo: 'Verificar e Reenviar',
            descricao: 'Verifique se todos os campos estão devidamente preenchidos e envie a ficha eletrotécnica corrigida para darmos seguimento ao pedido.'
          }
        ]
      },
      {
    ...
    content: [
      ...
      },
      {
        ...
        items: [
          ...
          {
            numero: 3,
            titulo: 'Evidências a Enviar',
            descricao: 'Após definir o local do PE, deve enviar as seguintes evidências:<br><br>✓ <strong>Foto geral</strong> da fachada/muro, incluindo a via pública e o local proposto<br>✓ <strong>Foto aproximada</strong> do local marcado com etiqueta "P (Portinhola/PE)" e "CC (Caixa de Contagem)"<br>✓ <strong>Foto com fita métrica</strong> mostrando as alturas (base e topo) para validação das cotas<br>✓ <strong>Screenshot de mapa</strong> (Google Maps) com pin no imóvel + morada e coordenadas<br>✓ <strong>Foto do poste/armário</strong> mais próximo e do acesso ao local (se aplicável)<br><br><div style=\'background-color: #E3F2FD; padding: 16px; border-radius: 8px; margin-top: 16px;\'><strong>Como submeter:</strong><br>Submeta as evidências (documentos e fotografias) no site da E-REDES na área <em>"Contacte-nos / Ligações à Rede e Aumentos de Potência / Quero adicionar informação e/ou enviar documentos"</em>.<br><br><img src=\'assets/images/pe_up.png\' alt=\'Site E-REDES\' style=\'max-width: 100%; margin-top: 16px; border-radius: 8px; border: 1px solid #ddd;\'></div>',
            link: {
              texto: 'Aceder ao site da E-REDES',
      ...
      },
      {
        ...
        items: [
          ...
          },
          {
            ...
            descricao: 'Caso o PE não esteja acessível pela via pública, será necessário <strong>relocar a portinhola</strong> para um local adequado que cumpra os requisitos regulamentares:<br><br>• Local no <strong>muro ou fachada exterior</strong><br>• Acessível <strong>diretamente da via pública</strong><br>• Sem obstáculos que impeçam o acesso<br>• Acesso permanente para intervenções da E-REDES<br><br>A montagem da portinhola é <strong>responsabilidade do cliente</strong>.'
          },
          {
            numero: 4,
            titulo: 'Submeter Evidências',
            descricao: 'Após alteração do ponto de entrega, envie as seguintes evidências:<br><br>✓ <strong>Fotos do novo local</strong> mostrando o acesso pela via pública<br>✓ <strong>Foto da portinhola instalada</strong> no novo local<br>✓ <strong>Foto mostrando as medidas</strong> (alturas regulamentares)<br>✓ <strong>Vista geral</strong> da propriedade com o PE visível<br><br><div style=\'background-color: #E3F2FD; padding: 16px; border-radius: 8px; margin-top: 16px;\'><strong>Como submeter:</strong><br>Submeta as evidências (documentos e fotografias) no site da E-REDES na área <em>"Contacte-nos / Ligações à Rede e Aumentos de Potência / Quero adicionar informação e/ou enviar documentos"</em>.<br><br><img src=\'assets/images/pe_up.png\' alt=\'Site E-REDES\' style=\'max-width: 100%; margin-top: 16px; border-radius: 8px; border: 1px solid #ddd;\'></div>',
            link: {
              texto: 'Aceder ao site da E-REDES',
              url: 'https://www.e-redes.pt'
            }
      ...
      },
      {
        ...
        items: [
          ...
          },
          {
            numero: 4,
            titulo: 'Submeter Evidências',
            descricao: 'Após adequação do ponto de entrega, envie as seguintes evidências:<br><br>✓ <strong>Fotos com fita métrica</strong> mostrando as alturas da base e topo da portinhola<br>✓ <strong>Fotos com fita métrica</strong> mostrando as alturas da base e topo da caixa de contagem<br>✓ <strong>Vista geral</strong> mostrando ambos os equipamentos instalados<br>✓ <strong>Foto de detalhe</strong> das medições com valores visíveis<br><br><div style=\'background-color: #E3F2FD; padding: 16px; border-radius: 8px; margin-top: 16px;\'><strong>Como submeter:</strong><br>Submeta as evidências (documentos e fotografias) no site da E-REDES na área <em>"Contacte-nos / Ligações à Rede e Aumentos de Potência / Quero adicionar informação e/ou enviar documentos"</em>.<br><br><img src=\'assets/images/pe_up.png\' alt=\'Site E-REDES\' style=\'max-width: 100%; margin-top: 16px; border-radius: 8px; border: 1px solid #ddd;\'></div>',
            link: {
              texto: 'Aceder ao site da E-REDES',
              url: 'https://www.e-redes.pt'
            }
      ...
      },
      {
        ...
        items: [
          ...
          },
          {
            numero: 4,
            titulo: 'Verificar e Reenviar',
            descricao: 'Verifique se as coordenadas estão corretas e envie a ficha eletrotécnica corrigida para darmos seguimento ao pedido.'
          }
        ]
      },
      {
      ...
      },
      {
        ...
        items: [
          ...
          },
          {
            numero: 5,
            titulo: 'Verificar e Reenviar',
            descricao: 'Verifique se todos os campos estão devidamente preenchidos contemplando toda a constituição do prédio e envie a ficha eletrotécnica corrigida para darmos seguimento ao pedido.'
          }
        ]
      },
      {
      ...
      },
      {
        ...
        items: [
          ...
          },
          {
            ...
            descricao: 'Para confirmar a <strong>data de abertura do pedido de ligação à rede</strong>, aceda ao <strong>Balcão Digital da E-REDES</strong> onde pode consultar o histórico e estado do seu pedido:<br>• Aceda a <a href=\'https://balcaodigital.e-redes.pt/\' target=\'_blank\' style=\'color: #0066CC; text-decoration: underline;\'>balcaodigital.e-redes.pt</a><br>• Faça login com as suas credenciais <br>• Consulte o histórico dos seus pedidos para verificar a data de abertura<br><br>Alternativamente, pode verificar o <strong>email de notificação</strong> que recebeu da E-REDES após a submissão do pedido, onde consta a data de abertura.<br>'
          },
          {
            numero: 3,
          ...
          },
          {
            ...
            link: {
              ...
              url: 'https://balcaodigital.e-redes.pt/'
            }
          }
        ]
      },
      ...
      },
      {
        ...
        items: [
          ...
          },
          {
            ...
            descricao: 'Selecione a tipologia do imóvel (Unifamiliar, Coletivo, Condomínio fechado ou Outros).<br><br>No campo "Instalação", escolha exatamente um dos valores válidos:<br>• <strong>Nova</strong><br>• <strong>Existente</strong><br><br>⚠️ Não utilize outros termos nem deixe o campo em branco.'
          },
          {
            numero: 3,
            titulo: 'Verificar a Coerência com o Quadro 5',
            descricao: 'O campo "Instalação" (Quadro 4) está diretamente relacionado com o Quadro 5:<br><br><strong>Se "Instalação = Nova"</strong><br>• No Quadro 5, campos associados a instalações existentes (ex.: NIP/OL ou CPE) devem ficar em branco, se ainda não atribuídos<br>• Preencher corretamente: Total de ramais, Tipo de utilização e Potências previstas<br><br><strong>Se "Instalação = Existente"</strong><br>• No Quadro 5, os dados de identificação elétrica existentes (ex.: NIP/OL, quando aplicável) devem estar preenchidos e coerentes<br>• O número de instalações, ramais e tipo de utilização tem de corresponder à tipologia indicada no Quadro 4'
          },
          {
            numero: 4,
            titulo: 'Revisão Final',
            descricao: 'Antes de submeter:<br>• Confirmar que o campo "Instalação" está preenchido com "Nova" ou "Existente"<br>• Garantir coerência entre Tipologia do imóvel (Quadro 4) e Número de instalações e ramais (Quadro 5)'
          },
          {
            numero: 5,
      ...
      },
      {
        ...
        items: [
          ...
          },
          {
            numero: 4,
            titulo: 'Verificar e Reenviar',
            descricao: 'Verifique se o campo de data e assinatura está devidamente preenchido e que a data está dentro do prazo válido. Envie a ficha eletrotécnica corrigida para darmos seguimento ao pedido.'
          }
        ]
      },
      {
      ...
      },
      {
        ...
        items: [
          ...
          },
          {
            ...
            descricao: 'É possível indicar outros valores para o fator de simultaneidade desde que estejam <strong>justificados em memória descritiva</strong>, incluindo o cálculo desses valores.<br><br>Por exemplo: quando todas as instalações são não domésticas, o fator é 1; caso seja apresentado um valor diferente, deve ser justificado em memória descritiva com o respetivo cálculo.'
          },
          {
            numero: 4,
    ...
    content: [
      ...
      },
      {
        ...
        items: [
          ...
          {
            numero: 4,
            titulo: 'Enviar o Documento Corrigido',
            descricao: 'Deverá enviar a Ficha Eletrotécnica com a assinatura do técnico responsável devidamente aposta para darmos seguimento ao pedido.'
          }
        ]
      },
      {
